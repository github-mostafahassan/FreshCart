                            ...
                            <>
                                ...
                                {data.data.data.map((product, inx) => {
                                    ...
                                    {product.category.name === "Women's Fashion" ?  <>
                                        ...
                                        <div key={inx} className={WomensFashionCss.card + " card border p-2 pb-5  text-center relative shadow-lg hover:shadow-2xl  transition-all duration-300 rounded-lg"}>
                                            ...
                                            <Link to={`/ProductDitelse/${product.id}`} className={WomensFashionCss.link }>
                                                <figure className={`${WomensFashionCss.figre + " "}`}>
                                                    ...
                                                    <figcaption className={`${WomensFashionCss.text} p-2 `} >
